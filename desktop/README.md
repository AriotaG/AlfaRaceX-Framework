...
- Bootstrap locale: versionato in `wwwroot/vendor` e incluso nella pubblicazione; nessuna dipendenza CDN a runtime.
- Servizi DFU: riuso diretto del core, da validare fisicamente, presente in `updater/AlfaRaceX.Updater`.
