...
| ARM cross-build C1 | PASS — RC3: 62,280 B Flash / 12,736 B RAM |
| ARM cross-build C2 | PASS — RC3: 39,124 B Flash / 12,736 B RAM |
| ARM cross-build BH | PASS — RC3: 38,600 B Flash / 12,736 B RAM |
